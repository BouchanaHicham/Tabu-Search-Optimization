    ...
    for i in range(num_lists):
        ...
        for j in range(list_size):
            ...
            while True:
                ...
                if b != a:                      #This Makes Sure That a will never be equal to b so we wont find cases like [[1,1]] ...
                    break
...
def sort_candidate_lists(candidate_lists):          # This Function Is for sorting our candidate list based on the obj_function
    sorted_lists = []
...
def Tabu_Search(Obj_Func , Init_Solution , Full_Candidates_Size):
    ...
    for i in range(Full_Candidates_Size):
        ...
        # We Pick Our Best Candidate , and we pass through our itteration index (i)  and the position of our best candidate (in theory)
...
# ====================================== Generate Our Candidates ======================================
list_size = 4
# We Generate The Candidate List Here  ====>    
                 #generate_candidate_lists(num_lists, list_size)
candidate_lists = generate_candidate_lists(Full_Candidates_Size, list_size)

#sorted_lists            = sort_candidate_lists(candidate_lists)         # We Sort Our Generated List Here based on the obj_function ofc
Candidate_List_Generator = sort_candidate_lists(candidate_lists)

print(Candidate_List_Generator)
# =======================================================================================================



# ====================================== Tabu_Search ======================================
# Tabu_Search(Init_Obj_Func , Init_Solution , Full_Candidates_Size )
Tabu_Search(Init_Obj_Func , Init_Solution , Full_Candidates_Size)
# =======================================================================================================
